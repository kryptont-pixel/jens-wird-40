...
await QRCode.toFile("public/qr/jens-upload.svg", target, { ...common, type: "svg", width: 1024 });
await QRCode.toFile("public/qr/jens-upload.png", target, { ...common, type: "png", width: 1600 });
await QRCode.toFile("public/qr/jens-upload-print.svg", target, { ...common, type: "svg", width: 2400, margin: 6 });
await QRCode.toFile("public/qr/jens-upload-print.png", target, { ...common, type: "png", width: 2400, margin: 6 });
