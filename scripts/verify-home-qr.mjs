...
const png = PNG.sync.read(await readFile("public/qr/jens-home.png"));
...
const expected = `${(process.env.VITE_PUBLIC_SITE_URL || process.env.PUBLIC_SITE_URL || "https://example.invalid").replace(/\/$/, "")}/`;
